...
import kidsImage from '@images/categories/kids.jpg'; // Assume you have an image for Kids Area
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <p class="text-sm text-primary-light sm:text-base text-gray-100 mb-4">
